              ...
              <div>
                ...
                <div className="cont-label"><h4>Contacts</h4></div>
                  <ul class="footer-list">
                    ...
                    <svg class="phone-icon" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
